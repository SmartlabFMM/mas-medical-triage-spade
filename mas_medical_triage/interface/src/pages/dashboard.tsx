...
// Mock data hooks
const useGetTriageStats = () => ({
  data: { total: 0, critical: 0, high: 0, medium: 0 },
  isLoading: false,
});

const useListTriageSessions = (): { data: TriageSession[]; isLoading: boolean } => ({
  data: [],
  isLoading: false,
});

// Simple urgency badge component
