...
Lit la base de données comme source de vérité et alloue/libère les ressources.
"""
...
class ResourceAgent(Agent):
    ...
    class AllocateResourceBehaviour(CyclicBehaviour):
        ...
        async def _allocate(self, loop, pid: str, patient_name: str,
            ...
            # Cherche un lit disponible dans la base de données
    ...
    async def setup(self):
        ...
        try:
            self.db = SheetsDB()
            self.db.connect()
            log_agent_state("ResourceAgent", "Database connected [OK]")
        except Exception as e:
        ...
        log_agent_state("ResourceAgent", "started (SPADE + Database)")
